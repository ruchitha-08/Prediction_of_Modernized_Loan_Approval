...
ROOT_URLCONF = 'prediction_of_modernized_loan_approval.urls'
...
WSGI_APPLICATION = 'prediction_of_modernized_loan_approval.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'prediction_of_modernized_loan_approval',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
