...
--
-- Host: localhost
-- Generation Time: Dec 08, 2021 at 12:22 PM
...
--
-- Database: `prediction_of_modernized_loan_approval`
--
CREATE DATABASE IF NOT EXISTS `prediction_of_modernized_loan_approval` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `prediction_of_modernized_loan_approval`;
...
(4, 'Suresh', 'Suresh123@gmail.com', 'Suresh', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(5, 'Gopal', 'Gopal123@gmail.com', 'Gopal', '9535866270', 'India', 'karnataka', 'Bangalore'),
(6, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore');
...
(21, 'SVM', '64.5320197044335'),
(22, 'Logistic Regression', '64.5320197044335'),
(23, 'Decision Tree Classifier', '64.5320197044335'),
(24, 'Random Forest Classifier', '64.5320197044335');
...
(23, 'Not Approved', '44.44444444444444'),
(24, 'Approved', '55.55555555555556');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_loan_approval_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_loan_approval_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Loan_ID` varchar(300) NOT NULL,
  `Gender` varchar(300) NOT NULL,
  `Married` varchar(300) NOT NULL,
  `Dependents` varchar(300) NOT NULL,
  `Education` varchar(300) NOT NULL,
  `Self_Employed` varchar(300) NOT NULL,
  `ApplicantIncome` varchar(300) NOT NULL,
  `CoapplicantIncome` varchar(300) NOT NULL,
  `LoanAmount` varchar(300) NOT NULL,
  `Loan_Amount_Term` varchar(300) NOT NULL,
  `Credit_History` varchar(300) NOT NULL,
  `Property_Area` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=10 ;

--
-- Dumping data for table `remote_user_loan_approval_prediction`
--

INSERT INTO `remote_user_loan_approval_prediction` (`id`, `Loan_ID`, `Gender`, `Married`, `Dependents`, `Education`, `Self_Employed`, `ApplicantIncome`, `CoapplicantIncome`, `LoanAmount`, `Loan_Amount_Term`, `Credit_History`, `Property_Area`, `Prediction`) VALUES
(1, 'LP001465', 'Male', 'Yes', '0', 'Graduate', 'No', '6080', '2569', '182', '360', '0', 'Rural', 'Not Approved'),
(2, 'LP001469', 'Male', 'No', '0', 'Graduate', 'Yes', '20166', '0', '650', '480', '1', 'Urban', 'Approved'),
(3, 'LP001013', 'Male', 'Yes', '0', 'Not Graduate', 'No', '2333', '1516', '95', '360', '1', 'Urban', 'Approved'),
(4, 'LP001030', 'Male', 'Yes', '2', 'Graduate', 'No', '1299', '1086', '17', '120', '1', 'Urban', 'Approved'),
(5, 'LP001050', 'Male', 'Yes', '1', 'Graduate', 'No', '1911', '116', '360', '360', '0', 'Semiurban', 'Approved'),
(6, 'LP001086', 'Male', 'No', '0', 'Not Graduate', 'No', '1442', '0', '35', '360', '1', 'Urban', 'Not Approved'),
(7, 'LP001086', 'Male', 'No', '0', 'Not Graduate', 'No', '1442', '0', '35', '360', '1', 'Urban', 'Not Approved'),
(8, 'LP001736', 'Male', 'Yes', '0', 'Graduate', 'No', '2221', '0', '60', '360', '0', 'Urban', 'Not Approved'),
(9, 'LP001743', 'Male', 'Yes', '2', 'Graduate', 'No', '4009', '1717', '116', '360', '1', 'Semiurban', 'Approved');
